...
public class CodeGeneratorUser {
    ...
    private static final String PACKAGE_NAME = "com.heima"; //报名
    private static final String MODEL_NAME = "user";   //模块名称

    //数据库地址
    private static final String DB_URL  = "jdbc:mysql://192.168.200.130:3306/leadnews_user?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    //嵌套工程
    private static final String projectPath = System.getProperty("user.dir")+
            File.separator+"heima-leadnews-service"+File.separator+"heima-leadnews-user";
